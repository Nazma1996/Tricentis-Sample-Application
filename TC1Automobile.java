...
public class TC1Automobile {
	...
	public static void main(String[] args) throws IOException {
		...
		List<WebElement> car1 = model.getOptions();
...
//		Select seat = new Select(driver.findElement(By.id("fuel")));
//		List<WebElement> space = seat.getOptions();
...
//		List<WebElement> tank = fuel.getOptions();
//		fuel.selectByValue("4");
		driver.findElement(By.id("fuel")).click();
		driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/form/div/section[1]/div[5]/select/option[2]")).click();
...
//		driver.findElement(By.xpath("/html/body/div[1]/div/div[1]/div/div/form/div/section[2]/div[6]/select/option[103]")).click();
		...
		Select rating = new Select(driver.findElement(By.id("meritrating")));
		List<WebElement> merit = rating.getOptions();
		rating.selectByValue("Bonus 3");
		...
		List<WebElement> ca = courtesy.getOptions();
		courtesy.selectByValue("No");
		
		driver.findElement(By.id("nextselectpriceoption")).click();
		
		//Page 4 
		String expeAm="1,573.00",actAm=null,expeClaim="Submit",actClaim=null,expeDiscount="5",actDiscount=null,expeCover="Limited",actCover=null;
		...
		FileUtils.copyFile(srcfile, new File("C:\\Users\\deepa\\OneDrive\\Pictures\\scree1.png"));
