...
public class TC4Camper {
	...
	public static void main(String[] args) throws IOException {
		...
		List<WebElement> motorcycle = make.getOptions();
		...
		List<WebElement> motorCycle = seat.getOptions();
		seat.selectByValue("4");
				
		List<WebElement> drive = driver.findElements(By.xpath("//*[@id=\"insurance-form\"]/div/section[1]/div[5]/p/label[1]"));
		drive.get(0).click();
		...
		//Page 4 
		String expeAm="1,752.00",actAm=null,expeClaim="Submit",actClaim=null,expeDiscount="5",actDiscount=null,expeCover="Limited",actCover=null;
		...
		FileUtils.copyFile(srcfile, new File("C:\\Users\\deepa\\OneDrive\\Pictures\\screen4.png"));
