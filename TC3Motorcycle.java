...
public class TC3Motorcycle {
	...
	public static void main(String[] args) throws IOException {
		...
		List<WebElement> Motorcycle = model.getOptions();
		...
		//Page 4 
		String expeAm="1,544.00",actAm=null,expeClaim="Submit",actClaim=null,expeDiscount="5",actDiscount=null,expeCover="Limited",actCover=null;
		...
		FileUtils.copyFile(srcfile, new File("C:\\Users\\deepa\\OneDrive\\Pictures\\screen3.png"));
